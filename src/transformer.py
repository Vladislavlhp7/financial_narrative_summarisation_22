...
def load_data(
    ...
    root: str = "..",
    v_seed: int = 42,
    training_downsample_rate: float = 0.9,
    data_augmentation="fr",
    type_load_directly: bool = True,
):
...
def run_experiment(
    ...
    model = BertForSequenceClassification.from_pretrained(
        "yiyanghkust/finbert-pretrain", num_labels=2
    )
    ...
    wandb.init(
        project="extractive_summarisation-data-augmentation-unified", entity="yotkovv"
    )
