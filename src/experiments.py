...
def experiment_comparison(
    project: str = "extractive_summarisation-data-augmentation-unified", seed: int = 42
):
    ...
    parameters_dict = {
        "seed": {"values": [seed]},
        "attention_type": {"values": ["dot", None]},
        "data_augmentation": {"values": ["fr"]},
        "lr": {"values": [1e-3]},
        "batch_size": {"values": [32]},
        "hidden_size": {"values": [64]},
        "downsample_rate": {"values": [0.8]},  # [0.5, 0.75, 0.9]
        "dropout": {"values": [0]},
        "rnn_type": {"values": ["gru"]},
        "epochs": {"value": 60},
        "project": {"value": project},
        "training_data": {"values": [f"{trainining_data}"]},
        "validation_data": {"values": [f"{validation_data}"]},
    }
...
def experiment_downsample90(
    ...
    parameters_dict = {
        "seed": {"values": [seed]},
        "attention_type": {"values": ["dot", None]},
        "data_augmentation": {"values": [None]},
        "lr": {"values": [1e-3]},
        "batch_size": {"values": [32]},
        "hidden_size": {"values": [64]},
        "downsample_rate": {"values": [0.9]},
        "dropout": {"values": [0]},
        "rnn_type": {"values": ["gru"]},
        "epochs": {"value": 60},
        "project": {"value": project},
