...
\begin{itemize}
    \item \emph{Summary Generation} - In our work we take top $k$ sentences based on the model's output probability distribution (Section~\ref{sec:evaluation}).
        ...
        As for the third point, we believe this is one of the main reasons why our GRU architecture returns a summary without any whole--sentence overlap with the gold standard (Fig.~\ref{fig:rnn_summary}).
