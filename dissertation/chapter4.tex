...
\begin{table}[ht]
    ...
    \begin{tabular}{lccc}
        ...
        \midrule
            $\spadesuit$ FinBERT-base & 0.544 & 0.382 & 0.524 \\
        ...
        \bottomrule
    \end{tabular}\caption{ROUGE $F1$ Scores on official validation set used as testing}
...
\begin{table}[ht]
    ...
    \begin{tabular}{lccc}
        ...
        \textbf{Model} & \textbf{ROUGE-1} & \textbf{ROUGE-2} & \textbf{ROUGE-L} \\
        \midrule
            $\spadesuit$ FinBERT-base (official validation set) & 0.544 & 0.382 & 0.524 \\
