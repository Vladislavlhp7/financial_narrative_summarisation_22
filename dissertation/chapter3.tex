...
We further outline how we deal with the data imbalance problem (Section~\ref{sec:data_augmentation}).
...
Throughout the hyperparameter tuning, we keep the learning rate fixed to $0.001$\footnote{
    Preliminary results showed that considerably different values lead to unsatisfiable results.
