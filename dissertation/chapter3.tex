...
Nevertheless, there still are some practical benefits of attention to our extractive summarisation system which we will discuss in Section~\ref{ch:evaluation}.
...
test their performance with ROUGE during the evaluation phase (Section~\ref{ch:evaluation}).